...
return [
    ...
    'tables' => [
        ...
        /*
         * alumni foreign key column name within interactions table.
         */
        'interactions_alumni_id_fk_column_name' => 'alumni_id',
        /*
         * user foreign key column type within interactions table.
         */
        'interactions_user_id_fk_column_type' => 'unsignedBigInteger',
        /*
         * alumni foreign key column type within interactions table.
         */
        'interactions_alumni_id_fk_column_type' => 'unsignedBigInteger',
        /*
