    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a target="_blank"  class="logo logo-dark">
                    <span class="logo-sm">
                    ...
                    <span class="logo-lg">
                        ...
                        <span class="text-success w-100 font-size-10 float-end">@lang('settings.website_title_short_3')</span>
                    </span>
                </a>

                <a target="_blank"  class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/common/images/logo/logo-fsc-noc.png') }}" alt="" height="35">
                    </span>
                    <span class="logo-lg">
                        <img class="" src="{{ URL::asset('assets/common/images/logo/logo-fsc-noc.png') }}" alt="" height="50">
                        <span class="text-success w-100 font-size-10 float-end">@lang('settings.website_title_short_3')</span>
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset('/assets/common/images/users/avatar-1.png') }}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item text-danger" href="{{route('user.profile')}}">
                        <i class="bx bx-user font-size-16 align-middle me-1 text-danger"></i>
