                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mb-1 mt-1 my-auto">
                                        ...
                                        <div>
                                            <p class="font-size-12 text-center text-muted">@lang('login.email_verify_info') </p>
                                        </div>

                                        <div class="mt-1">
                                            <form class="form-horizontal" method="POST" action="{{ route('email_verify') }}">
                                                @csrf
                                                <div class="mb-3">
                                                ...
                                                <div class="mt-3 d-grid">
                                                    <button class="btn btn-primary waves-effect waves-light" type="submit">@lang('login.send_verify_link')</button>
                                                </div>
