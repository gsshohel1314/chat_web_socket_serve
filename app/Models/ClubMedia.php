...
class ClubMedia extends Model
{
    ...
    protected static $logName = 'club_media';
    ...
    {
        $log_name = trans(self::$logName . '.club_media');
    ...
    public function clubMediaPhoto()
    {
        return $this->morphOne(File::class, 'fileable')->latest()->where('type', 'media_main_image');
    }
